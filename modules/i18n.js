...
var I18N = {
  fr: {
    ...
    nav_notifications:'Notifications', nav_ai:'AI', nav_veggieref:'Catalogue',
    ...
    // Getting started
    gs_title:'Par o\u00f9 commencer ?',
    gs_sub:'3 \u00e9tapes pour lancer votre jardin',
    gs_step1_title:'Cr\u00e9ez votre espace de culture',
    gs_step1_desc:'Potager, bac, carr\u00e9, balcon \u2014 choisissez votre type d\'espace.',
    gs_step1_cta:'Cr\u00e9er \u2192',
    gs_step2_title:'Parcourez le catalogue',
    gs_step2_desc:'Tomates, courgettes, salades\u2026 choisissez ce que vous voulez cultiver.',
    gs_step2_cta:'Explorer \u2192',
    gs_step3_title:'Planifiez votre saison',
    gs_step3_desc:'L\'app adapte les conseils et alertes \u00e0 votre jardin.',
    gs_step3_cta:'Planifier \u2192',
    ...
    risk_flood_text:'Risque d\'inondation des espaces de culture. V\u00e9rifiez le drainage. \u00c9vitez d\'arroser.',
    ...
    beds_legend_seedling:'Jeune plant', beds_legend_growing:'Croissance',
    ...
    beds_lbl_sun:'Ensoleillement', beds_lbl_soil:'Type de sol',
    beds_sun_shade:'Ombre', beds_sun_partial:'Mi-ombre', beds_sun_full:'Plein soleil',
    beds_soil_sandy:'Sableux', beds_soil_loam:'Limoneux', beds_soil_clay:'Argileux', beds_soil_peat:'Humifère', beds_soil_rich:'Humifère',
    beds_sun_warn:'⚠️ {name} a besoin de plein soleil — cet espace est ombragé',
    spaceType_bacs:'Contenants & pots', spaceType_pots:'Contenants & pots', spaceType_pleineTerre:'Pleine terre', spaceType_mixte:'Mixte', spaceType_balcon:'Balcon',
    ...
    stage_all:'Toutes', stage_planned:'Planifi\u00e9es', stage_seedling:'Jeune plant',
    ...
    crops_lbl_veggie:'L\u00e9gume', crops_lbl_bed:'Espace',
    ...
    settings_filter_sow_now:'\uD83C\uDF31 \u00C0 semer',
    settings_filter_container:'📦 Balcon/Pot',
    ...
    companion_conflict:'Association déconseillée avec {names} (présent dans cet espace)',
    companion_present:'Bonne association avec {names} (présent dans cet espace)',
    ...
    task_water_bed:'{bed} : ~{liters} L cette semaine (~{litersDay} L/jour)',
    task_reason_water_bed:'La pluie prévue ({rain} mm) ne couvre pas les besoins de tes cultures. Arrose pour compenser.',
    task_water_rain_ok:'Pluie prévue ({mm} mm) — pas besoin d\'arroser avant {day}',
    task_reason_water_rain:'La pluie prévue ({mm} mm) est suffisante — tes cultures seront bien arrosées naturellement.',
    ...
    health_bed_overload_risk:'Espace {bed} satur\u00e9 ({pct}%) \u2014 comp\u00e9tition entre cultures',
    health_bed_overload_sug:'D\u00e9placez une culture vers un espace moins charg\u00e9.',
    health_bed_full_risk:'Espace {bed} tr\u00e8s charg\u00e9 ({pct}%)',
    ...
    intel_adv_prep_low:'Espace sous-utilis\u00e9 ({pct}% d\'occupation)',
    ...
    opp_hi_text:'{pct}% de rendement moyen sur {n} r\u00e9coltes. P\u00e9riode id\u00e9ale. Espace sugg\u00e9r\u00e9\u00a0: {bed}.',
    ...
    soil_loam:'Limoneux', soil_clay:'Argileux', soil_sandy:'Sableux', soil_rich:'Humifère',
  ...
  en: {
    ...
    // Getting started
    gs_title:'Where to start?',
    gs_sub:'3 steps to set up your garden',
    gs_step1_title:'Create your growing space',
    gs_step1_desc:'Raised bed, container, ground plot, balcony \u2014 pick your type.',
    gs_step1_cta:'Create \u2192',
    gs_step2_title:'Browse the catalogue',
    gs_step2_desc:'Tomatoes, courgettes, lettuce\u2026 pick what you want to grow.',
    gs_step2_cta:'Explore \u2192',
    gs_step3_title:'Plan your season',
    gs_step3_desc:'The app adapts advice and alerts to your garden.',
    gs_step3_cta:'Plan \u2192',
    ...
    risk_flood_text:'Risk of space flooding. Check drainage. Avoid watering.',
    ...
    beds_lbl_sun:'Sunlight', beds_lbl_soil:'Soil type',
    beds_sun_shade:'Shade', beds_sun_partial:'Partial sun', beds_sun_full:'Full sun',
    beds_soil_sandy:'Sandy', beds_soil_loam:'Loam', beds_soil_clay:'Clay', beds_soil_peat:'Humus-rich', beds_soil_rich:'Humus-rich',
    beds_sun_warn:'⚠️ {name} needs full sun — this space is shaded',
    spaceType_bacs:'Containers & pots', spaceType_pots:'Containers & pots', spaceType_pleineTerre:'In-ground', spaceType_mixte:'Mixed', spaceType_balcon:'Balcony',
    ...
    settings_filter_sow_now:'\uD83C\uDF31 Sow now',
    settings_filter_container:'📦 Balcony/Pot',
    ...
    companion_conflict:'Bad companion: {names} (present in this space)',
    companion_present:'Good companion: {names} (present in this space)',
    ...
    task_water_bed:'{bed}: ~{liters} L this week (~{litersDay} L/day)',
    task_reason_water_bed:'Forecast rain ({rain} mm) won\'t cover your crops\' needs this week. Water to make up the difference.',
    task_water_rain_ok:'Rain forecast ({mm} mm) — no need to water before {day}',
    task_reason_water_rain:'Forecast rain ({mm} mm) is enough — your crops will be naturally watered.',
    ...
    soil_loam:'Loam', soil_clay:'Clay', soil_sandy:'Sandy', soil_rich:'Humus-rich',
